...
@store1.employees.create(first_name: "Kathleen", last_name: "Pearce", hourly_rate: 80)

@store2.employees.create(first_name: "Zach", last_name: "Treble", hourly_rate: 60)
@store2.employees.create(first_name: "Kim", last_name: "Irvine", hourly_rate: 80)
